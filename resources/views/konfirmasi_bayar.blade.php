...
<div class="container">
    <div class="mt-4" style="min-height: 450px">
        ...
        <div class="mt-5 text-center">
            <h3 class="text-uppercase" style="color:#DD16EB">silahkan lakukan konfimasi pembayaran untuk pesanan anda</h3>
        </div>
        <div class="row mt-3 border rounded">
            <div class="col-md-4 my-auto mt-3 mb-3">
                ...
                <div class="mt-3 text-center">
                    <h5 class="text-primary">{{$data_sewa_barang->barang->barang_nama}}</h5>
                    <h6 class="text-dark">{{$data_sewa_barang->sewa_tanggal_mulai}} sampai {{$data_sewa_barang->sewa_tanggal_berakhir}}</h6>
            ...
            <div class="col-md-8 my-auto mt-3 mb-3">
                <form action="{{ route('konfirmasi_pembayaran') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div>
                        <h4>{{$data_sewa_barang->barang->barang_nama}}</h4> 
                    </div>
                    <div class="mt-3 row">
                    ...
                    <div class="mt-3 row">
                        ...
                        <input type="text" class="form-control text-capitalize col-md-7 @error('jml_transfer') is-invalid @enderror" name="jml_transfer" id="jml_transfer" placeholder="masukan nominal transfer">
                        @error('jml_transfer')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
